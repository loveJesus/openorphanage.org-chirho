...
<section class="min-h-screen flex items-center justify-center py-24 px-4 bg-gradient-to-b from-slate-50 via-rose-50/30 to-slate-50">
	<div class="w-full max-w-md">
		<div class="text-center mb-8">
			...
			<p class="text-slate-500">Sign in to your OpenOrphanage account</p>
		</div>
			...
			<form onsubmit={handleSubmitChirho} class="space-y-6">
				<div>
					...
					<input
						...
						required
						class="w-full bg-slate-50 border border-slate-300 rounded-lg px-4 py-3 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-transparent"
				...
				<div>
					<div class="flex justify-between items-center mb-2">
						<label for="password-chirho" class="block text-sm font-medium text-slate-700">Password</label>
						<a href="/auth-chirho/forgot-password-chirho" class="text-xs text-rose-600 hover:text-rose-700">Forgot password?</a>
					</div>
					<input
						type="password"
						id="password-chirho"
				...
				<p class="text-center text-slate-500 text-sm">
					...
					<a href="/auth-chirho/register-chirho" class="text-rose-600 hover:text-rose-700">Register</a>
				</p>
			</form>
		</div>
	</div>
