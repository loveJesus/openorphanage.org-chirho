				...
				<div>
					...
					<div class="relative">
						<select
							...
							class="w-full appearance-none bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3 pr-10 text-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500 focus:outline-none cursor-pointer"
						>
